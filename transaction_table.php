...
<body>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold;">LIST OF TRANSACTIONS IN OUR SYSTEM</h4>
        <a href="transaction_form.php" class="btn btn-primary" style="margin-top: 0px;">New Transaction</a>
