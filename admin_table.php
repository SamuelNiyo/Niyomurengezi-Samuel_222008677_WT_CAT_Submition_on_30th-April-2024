...
<body>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold;">LIST OF ADMIN IN OUR SYSTEM</h4>
        <a href="user_form.php" class="btn btn-primary" style="margin-top: 0px;">New Admin</a>
